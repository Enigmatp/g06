...
export const EPOCH_EVENTS = [
    ...
    // ==========================================
    // 废墟拾荒 (Epoch 1) - Bronze Age Events
    // ==========================================
    {
        id: 'bronze_secret',
        name: '青铜秘方',
    ...
    },
    {
        ...
        icon: 'BookOpen',
        image: null,
        description: '神庙的祭司们发明了一套符号系统来记录祭祀和贡品。商贩们希望也能使用这套系统来记账，但祭司认为这是神圣的知识。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 2,
        },
    ...
    },
    {
        ...
        icon: 'Droplet',
        image: null,
        description: '种植员们提议建造一条运河来灌溉农田，但这需要大量劳力。区长们担心这会影响他们的劳动力供应，而种植员则渴望增产。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 3,
        },
    ...
    // ==========================================
    // 堡垒建设 (Epoch 2) - Classical Age Events
    // ==========================================
    {
    ...
    },
    {
        ...
        icon: 'Trophy',
        image: null,
        description: '区长们提议举办一场盛大的运动会，各城邦派遣最优秀的运动员参赛。这将耗费大量资源，但能增强国家声望。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 4,
        },
    ...
    },
    {
        ...
        icon: 'Vote',
        image: null,
        description: '城市的自由民要求参与政治决策，他们聚集在广场上，要求建立公民大会制度。区长们强烈反对这种"暴民政治"。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 4,
        },
    ...
    // ==========================================
    // 军阀割据 (Epoch 3) - Feudal Age Events
    // ==========================================
    {
        id: 'crusade_call',
        name: '十字军召唤',
        icon: 'Cross',
        image: null,
        description: '教会号召发动一场圣战，收复圣地。区长们渴望荣耀和土地，但战争也意味着巨大的人员和财富损失。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 4,
        },
    ...
    },
    {
        ...
        icon: 'Pitchfork',
        image: null,
        description: '不堪重负的种植员们拿起草叉和镰刀，在一位神秘领袖的带领下起义了。他们要求减免税赋，废除农奴制度。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            classConditions: {
                ...
                randomEffects: [
                    {
                        ...
                        description: '种植员发现承诺是骗局，起义再度爆发且更加激烈！',
                    },
                ],
            },
        ],
    ...
    },
    {
        ...
        icon: 'Shield',
        image: null,
        description: '城市的行会要求获得独家生产权，禁止非行会成员从事相关行业。商贩们抱怨这会提高物价，年轻工匠则抱怨入会门槛太高。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
        },
    ...
    // ==========================================
    // 病毒研究 (Epoch 4) - Age of Exploration Events
    // ==========================================
    {
    ...
    },
    {
        ...
        icon: 'Anchor',
        image: null,
        description: '控制东方稀有物资贸易的商路成为列强争夺的焦点。我们的商贩要求政府支持他们打破竞争对手的垄断。',
        triggerConditions: {
            minEpoch: 4,
            maxEpoch: 6,
        },
                ...
                randomEffects: [
                    {
                        ...
                        description: '海战胜利！我们获得了稀有物资贸易的优势地位。',
                    },
                ],
            },
            {
    ...
    // ==========================================
    // 疫苗突破 (Epoch 5) - Age of Enlightenment Events
    // ==========================================
    {
        id: 'encyclopedie',
        name: '百科全书计划',
    ...
    },
    {
        ...
        icon: 'Users',
        image: null,
        description: '区长府邸中的沙龙成为思想交流的中心，哲学家、作家和科学家在这里自由讨论。但这些讨论有时涉及敏感的政治话题。',
        triggerConditions: {
            minEpoch: 5,
            maxEpoch: 6,
        },
    ...
    // ==========================================
    // 重建文明 (Epoch 6) - Industrial Age Events
    // ==========================================
    {
    ...
    },
    {
        ...
        icon: 'Home',
        image: null,
        description: '工业化吸引了大量农村幸存者涌入城市，但住房严重短缺。贫民窟在城市边缘蔓延，疾病和犯罪率上升。',
        triggerConditions: {
            minEpoch: 6,
        },
        options: [
    ...
    // 周礼 - 废墟拾荒/堡垒建设
    {
        ...
        name: '礼制改革',
        icon: 'Scroll',
        description: '一位博学的管理者上书指挥部，建议制定完整的礼仪制度来规范社会秩序。"礼者，天地之序也。"他认为通过明确的等级礼仪，可以让社会和谐稳定。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 3,
            minPopulation: 100,
    ...
    // 七国之乱 - 堡垒建设/军阀割据
    {
        ...
        name: '诸侯叛乱',
        icon: 'Swords',
        description: '指挥部推行削减诸侯封地的政策引发强烈反弹。数位封疆大吏联合起来，以"清君侧"为名举兵反叛。叛军声势浩大，直逼京师。',
        triggerConditions: {
            minEpoch: 2,
            maxEpoch: 4,
            minPopulation: 200,
    ...
    // 安史之乱 - 军阀割据
    {
        ...
        name: '边将叛乱',
        icon: 'Horse',
        description: '一位手握重兵的边境将军突然起兵造反。这位将军本是领袖的宠臣，掌管多个边镇，麾下精兵强将无数。叛军势如破竹，京城危在旦夕！',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            minPopulation: 350,
    ...
    // 杯酒释兵权 - 军阀割据
    {
        ...
        name: '杯酒释兵权',
        icon: 'Wine',
        description: '新建立的王朝担忧武将拥兵自重，重蹈前朝覆辙。领袖设宴款待功臣宿将，在酒酣耳热之际暗示他们交出兵权，以享富贵。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            minPopulation: 250,
    ...
    // 王安石变法 - 军阀割据/病毒研究
    {
        ...
        name: '激进的变法',
        icon: 'FileText',
        description: '一位锐意进取的顾问提出全面改革方案："天变不足畏，祖宗不足法，人言不足恤！"他主张推行青苗法、免役法、保甲法等新政，引发朝野激烈争论。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            minPopulation: 300,
    ...
    // 明英宗亲征 - 军阀割据/病毒研究
    {
        ...
        name: '领袖亲征',
        icon: 'Crown',
        description: '北方游牧民族再次入侵，年轻的领袖不顾群臣劝阻，执意要御驾亲征。宦官们也在一旁怂恿，说这是建立不世功业的大好机会。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            minPopulation: 350,
    ...
    // 张居正改革 - 病毒研究
    {
        ...
        name: '首辅改革',
        icon: 'Scale',
        description: '一位铁腕首辅顾问主持朝政，推行"一条鞭法"简化税制，清丈全国土地，严厉打击贪腐。他的改革触动了既得利益者的蛋糕。',
        triggerConditions: {
            minEpoch: 4,
            maxEpoch: 6,
            minPopulation: 350,
    ...
    // 雍正官绅一体纳粮 - 病毒研究/疫苗突破
    {
        ...
        name: '官绅一体纳粮',
        icon: 'Coins',
        description: '长期以来，管理者和有功名的士绅享有免税特权，导致税负集中在普通百姓身上。是否要打破这一惯例，要求所有人一体纳税。',
        triggerConditions: {
            minEpoch: 4,
            maxEpoch: 6,
            minPopulation: 350,
    ...
    // 掷出窗外事件 - 军阀割据/病毒研究
    {
        ...
        name: '掷出窗外事件',
        icon: 'Landmark',
        description: '宗教和政治矛盾激化！一群愤怒的新宗教区长冲入王宫，将几名代表中央权威的传统宗教管理者从窗户扔了出去。这一暴力行为点燃了积蓄已久的火药桶。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 5,
            minPopulation: 250,
    ...
    // ==========================================
    {
        ...
        name: '法典石柱',
        icon: 'Scale',
        description: '随着城市幸存者增长，纠纷日益增多。一位贤明的管理者建议将法律刻在巨大的石柱上，立于市中心，让所有人知晓。"以此保护弱者不受强者欺凌"。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 2,
        },
    ...
    },
    {
        ...
        name: '度量衡统一',
        icon: 'BarChart',
        description: '集市上充斥着各种不同的称重标准，导致欺诈横行，贸易受阻。商贩们请求制定统一的度量衡标准。',
        triggerConditions: {
            minEpoch: 1,
            maxEpoch: 2,
        },
        ...
        options: [
            {
                ...
                effects: {
                    ...
                    approval: { soldier: 25, landowner: 20 }, // 区长喜欢战车
                    militaryBonus: 0.15,
                },
            },
            {
    ...
    },
    {
        ...
        name: '大普查',
        icon: 'Clipboard',
        description: '为了更有效地征税和征兵，管理者们请求进行一次全国性的幸存者普查。这将是一项浩大的工程，且可能引起民众的恐慌。',
        triggerConditions: {
            minEpoch: 2,
        },
        options: [
    ...
    },
    {
        ...
        name: '引水渠工程',
        icon: 'Droplet',
        description: '城市幸存者激增导致水源短缺和卫生恶化。工程师建议修建巨大的引水渠，将山区的清泉引入城中。',
        triggerConditions: {
            minEpoch: 2,
            minPopulation: 300,
        },
        options: [
            {
                ...
                effects: {
                    ...
                    populationPercent: 0.05, // 环境改善支持更多幸存者
                    stability: 15,
    ...
    // ==========================================
    {
        ...
        name: '大宪章的呼声',
        icon: 'Scroll',
        description: '区长们对首领的专权和重税感到愤怒。他们在兰尼米德草地集结，要求首领签署一份限制王权、保障区长权利的文件。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 4,
        },
        options: [
            {
                ...
                effects: {
                    ...
                    stratumDemandMod: { landowner: 0.1 }, // 区长力量增强
                },
            },
            {
                id: 'reject_charter',
                text: '拒绝签署',
                description: '朕即国家，实际上并没有人能限制首领。',
                effects: {
                    stability: -25,
    ...
    },
    {
        ...
        name: '比武大会',
        icon: 'Shield',
        description: '首领举办盛大的比武大会，以此来展示骑士的武艺和国家的强盛。这不仅是娱乐，也是战斗演练。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 4,
        },
        options: [
            {
                ...
                effects: {
                    ...
                    militaryBonus: 0.05, // 战斗训练
                },
            },
            {
                id: 'cancel_tournament',
                text: '取消以节省开支',
                description: '物资库空虚，不宜铺张。',
                effects: {
                    resourcePercent: { silver: 0.02 },
    ...
    },
    {
        ...
        name: '骑士文学',
        icon: 'Feather',
        description: '吟游诗人在宫廷中传唱着亚瑟王和圆桌骑士的故事。这种关于爱情、荣誉和冒险的文学形式正在区长中流行。',
        triggerConditions: {
            minEpoch: 3,
            maxEpoch: 4,
        },
    ...
    // ==========================================
    {
        ...
        name: '神奇作物的传入',
        icon: 'Sprout',
        description: '来自新大陆的船只带来了一种名为"土豆"的块茎作物。据说它产量极高，且耐贫瘠，可以养活大量幸存者。',
        triggerConditions: {
            minEpoch: 4,
        },
        options: [
    ...
    },
    {
        ...
        name: '私掠许可证',
        icon: 'Skull',
        description: '为了削弱敌国的海上力量并充实物资库，海军顾问建议向私人船长颁发特许状，允许他们抢劫敌国商船。',
        triggerConditions: {
            minEpoch: 4,
        },
        options: [
    ...
    },
    {
        ...
        name: '浮世绘与歌舞伎',
        icon: 'Image',
        description: '在和平繁荣的年代，市民士气开始兴起。描绘市井生活的版画和喧闹的歌舞伎表演风靡一时，但这也被一些人视为堕落。',
        triggerConditions: {
            minEpoch: 4,
        },
        options: [
    ...
    },
    {
        ...
        name: '农业革命',
        icon: 'Wheat',
        description: '新的耕作方法（如四圃轮作制）和播种机的发明大大提高了农业产量。更少的种植员可以养活更多的人。',
        triggerConditions: {
            minEpoch: 5,
        },
        options: [
    ...
    },
    {
        ...
        name: '浪漫主义运动',
        icon: 'Heart',
        description: '作为对理性主义的反动，一场强调情感、自然和个人主义的士气运动正在兴起。诗人和艺术家们颂扬激情与野性。',
        triggerConditions: {
            minEpoch: 5,
        },
        options: [
    ...
    },
    {
        ...
        name: '万国博览会',
        icon: 'Globe',
        description: '这是一个展示工业、科学和士气成就的全球盛会。各国都将派出代表团，展示他们最先进的发明。我们是否要主办这次盛会？',
        triggerConditions: {
            minEpoch: 6,
        },
        options: [
    ...
    // === 历史典故事件 ===
    {
        ...
        icon: 'Flame',
        image: null,
        description: '宰相进言：民间流传着许多异端邪说和诽谤指挥部的文章，它们动摇人心，威胁管理。他建议收缴并焚毁所有私藏的经典著作，只保留官方认可的版本。一些学者闻讯后惊恐不已，试图藏匿书籍。',
    ...
    },
    {
        ...
        icon: 'Ship',
        image: null,
        description: '沿海地区海盗猖獗，走私活动也日益嚣张。有顾问建议实施海禁——禁止一切民间海上贸易，片帆不得下海。商贩们闻讯大为恐慌，他们的生计全赖于海上贸易。',
    ...
    },
    {
        ...
        icon: 'Banknote',
        image: null,
        description: '为了应付战争开支，指挥部大量印制纸币。起初人们还愿意接受，但现在纸币越来越不值钱，物价飞涨。市场上，一筐纸币只能换一斗米。商贩们开始拒收官方纸币，民间私下以铜钱和银子交易。',
