(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=7,t=[180,240,300,360,420,480,540],n=[{id:`m1`,label:`解锁一`,desc:`5 分钟`,dayFraction:5/180},{id:`m2`,label:`解锁二`,desc:`25 分钟`,dayFraction:25/180},{id:`m3`,label:`解锁三`,desc:`1 小时`,dayFraction:60/180},{id:`m4`,label:`解锁四`,desc:`2 小时`,dayFraction:120/180}];function r(e,t,n){return Math.max(t,Math.min(n,e))}function i(t){if(t<=0)return`未开始`;let n=Math.floor(t),r=t-n;if(n>=e&&r===0)return`第 ${e} 天`;if(r===0)return`第 ${n} 天`;let i=Math.round(r*60);if(n===0){let e=Math.round(r*180);if(e<60)return`${e} 分钟`;let t=Math.floor(e/60),n=e%60;return n===0?`${t} 小时`:`${t} 小时 ${n} 分`}return i===0?`第 ${n} 天`:`第 ${n} 天 +${i} 分`}var a=0,o=!1;document.getElementById(`app`).innerHTML=`
